...
namespace Lexer
{
  ...
  public abstract class TokenState : ITokenState
  {
    ...
    internal bool addOneCharToken(string oneCharTok)
    {
    ...
    internal bool removeOneCharToken(string oneCharTok)
    {
      return oneCharTokens_.Remove(oneCharTok);
    }
    //----< add token to special two char tokens >-------------------

    internal bool addTwoCharToken(string twoCharTok)
    {
    ...
    internal bool removeTwoCharToken(string twoCharTok)
    {
  ...
  public class WhiteSpaceState : TokenState
  {
    ...
    override public Token getTok()
    {
      ...
      while (context_.currentState_.isWhiteSpace())  
      {
        tok.Append((char)context_.src.next());
      }
      return tok.ToString();
